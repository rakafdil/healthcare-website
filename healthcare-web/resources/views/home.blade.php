...
<div class="w-screen h-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-hidden">
    ...
    <!-- Hero Content -->
    <div class="relative z-20 flex flex-col justify-center text-right  text-right h-full px-8 max-w-screen-xl mx-auto ">
    ...
    <div class="relative z-30 w-full h-auto flex justify-between space-x-4 mt-8 top-14">
        <!-- Artikel 1 -->
