            ...
            <div class="w-full flex justify-between space-x-4 mt-16 mb-10">
                ...
                <div class="w-1/4 h-full bg-white shadow-lg rounded-3xl p-4">
                    ...
                    <a href="{{ route('baca-blog') }}"
                        class="inline-block bg-blue-600 text-white px-4 py-2 rounded-3xl hover:bg-blue-700">Masuk
                        Halaman</a>
                </div>
                ...
                <div class="w-1/4 h-full bg-white shadow-lg rounded-3xl p-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                        class="w-12 h-14 object-cover rounded-md mb-4">
                        <g fill="#3b82f6">
                            <path fill-rule="evenodd"
                                d="M20 2a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-2H3v-2h2v-2H3v-2h2v-2H3V9h2V7H3V5h2V3a1 1 0 0 1 1-1zm-1 2H7v16h12zm-5 4v3h3v2h-3.001L14 16h-2l-.001-3H9v-2h3V8z" />
                    </svg>
