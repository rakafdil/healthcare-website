    ...
    <div class="w-full h-screen flex flex-col items-center ">
        ...
        <div class="relative top-14">
            <form action="{{ route('blog.search') }}" method="GET"
                class="flex items-center w-full max-w-md space-x-0.5">
                <input type="text" name="query" placeholder="Cari artikel..."
                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                <button type="submit"
                    class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Cari</button>
            </form>
        </div>
        ...
        <div class="relative w-full h-auto flex justify-between space-x-4 mt-8 top-14">
            ...
            <div class="w-1/3 bg-white shadow-lg rounded-lg p-4">
                ...
                <p class="text-gray-600 mb-4">Deskripsi singkat artikel 1. Dapatkan informasi menarik tentang topik ini.
                </p>
                <a href="{{ route('baca-blog') }}"
                    class="inline-block bg-blue-600 text-white px-4 py-2 rounded-2xl hover:bg-blue-700">Baca Artikel</a>
            </div>
            ...
            <div class="w-1/3 bg-white shadow-lg rounded-lg p-4">
                ...
                <p class="text-gray-600 mb-4">Deskripsi singkat artikel 2. Pelajari lebih lanjut tentang gaya hidup
                    sehat.</p>
                <a href="{{ route('baca-blog') }}"
                    class="inline-block bg-blue-600 text-white px-4 py-2 rounded-2xl hover:bg-blue-700">Baca Artikel</a>
            </div>
