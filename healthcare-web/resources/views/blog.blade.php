    ...
    <div class="w-full h-screen flex flex-col items-center ">
        ...
        <div class=" top-14 my-14 mb-4">
            <form action="{{ route('blog.search') }}" method="GET"
                ...
                <button type="submit"
                    class="px-4 py-2 bg-[#499BE8] text-white rounded-md hover:bg-[#418ACE]">Cari
                </button>
            </form>
        </div>
                ...
                <div class="carousel-slides">
                    <div class="relative w-full h-auto flex justify-between space-x-4 top-4 mb-8 px-16">
                        ...
                        <div class="w-1/4 h-auto bg-white shadow-lg rounded-lg ">
                            ...
                            <p class="text-gray-600 mb-4 ml-2">Deskripsi singkat artikel 1. Dapatkan informasi menarik tentang topik ini.
                            </p>
                            <a href="{{ route('baca-blog') }}"
                                class="inline-block bg-[#499BE8] text-white px-4 py-2 rounded-2xl hover:bg-[#418ACE] ml-2">Baca Artikel</a>
                        </div>
                        ...
                        <div class="w-1/4 h-auto bg-white shadow-lg rounded-lg ">
                            ...
                            <p class="text-gray-600 mb-4 ml-2">Deskripsi singkat artikel 2. Pelajari lebih lanjut tentang gaya hidup
                                sehat.</p>
                            <a href="{{ route('baca-blog') }}"
                                class="inline-block bg-[#499BE8] text-white px-4 py-2 rounded-2xl hover:bg-[#418ACE] mb-2 ml-2">Baca Artikel</a>
                        </div>
                        ...
                        <div class=" w-1/4 h-auto bg-white shadow-lg rounded-lg ">
                            ...
                            <p class="text-gray-600 mb-4 ml-2">Deskripsi singkat artikel 3. Temukan tips hidup sehat di artikel ini.</p>
                            <a href="{{ route('baca-blog') }}"
                                class="inline-block bg-[#499BE8] text-white px-4 py-2 rounded-2xl hover:bg-[#418ACE] ml-2">Baca Artikel</a>
                        </div>
                    </div>
                    ...
                    <!-- Tombol Navigasi -->                    
                        ...
                        <div class="flex justify-center space-x-2 ">
                            ...
                            <button class="w-8 h-8 rounded-full bg-gray-300 text-black font-semibold" onclick="goToSlide(0)">1</button>
                            <button class="w-8 h-8 rounded-full bg-gray-300 text-black font-semibold" onclick="goToSlide(1)">2</button>
                            <button class="w-8 h-8 rounded-full bg-gray-300 text-black font-semibold" onclick="goToSlide(2)">3</button>
                            <button class="w-8 h-8 rounded-full bg-gray-300 text-black font-semibold" onclick="goToSlide(3)">4</button>
                            <button class="w-8 h-8 rounded-full bg-gray-300 text-black font-semibold" onclick="goToSlide(4)">5</button>
