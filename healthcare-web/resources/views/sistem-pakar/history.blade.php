            ...
            <div class="bg-gray-50 border-b border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button onclick="confirmDelete({{ $id_session }})"
                        ...
                        <button onclick="retakeDiagnosis({{ $id_session }})"
                            class="flex items-center text-gray-700 hover:text-green-600 transition-colors duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        function confirmDelete(sessionId) {
            if (confirm('Apakah Anda yakin ingin menghapus riwayat ini?')) {
                ...
                form.method = 'POST';
                form.action = `/sistem-pakar/history/${sessionId}`;
        ...
        function retakeDiagnosis(sessionId) {
            if (confirm('Apakah Anda ingin melakukan diagnosa ulang dengan gejala yang sama?')) {
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = `/sistem-pakar/history/${sessionId}/retake`;
